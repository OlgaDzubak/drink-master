...
import { FormError, RecipeTitle, RecipeWrapper, RecipeLabel, RecipeTextArea } from './RecipePreparation.styled';

const RecipePreparation = ({values, errors, touched, handleChange, handleBlur}) => {
  ...
  return  <>
            ...
            <RecipeWrapper>
              ...
              { touched.instructions && errors.instructions ? <FormError>{errors.instructions}</FormError> : null }
