...
const termsOfServiceText = `This "User Agreement" (the "Agreement") sets forth the terms and conditions governing the use of the Drink Master application ("App") and its services.
...
export const modalTitles = { privacyPolicyText: privacyPolicyTitle, termsOfServiceText: termsOfServiceTitle };
export const modalTexts = { privacyPolicyText, termsOfServiceText };
