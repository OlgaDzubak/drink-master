import{k as B,l as y,m as ne,o as re,p as ae,n as i,r as s,j as t,u as se,q as le,G as de,s as E,F as ce,t as pe,v as he,h as xe,i as me,w as ue,M as ge,x as be}from"./index-47dec874.js";import{P as fe}from"./PageTitle-2fb74ed5.js";import{T as we}from"./Hourglass-f7e9818e.js";import{s as ke,a as ve}from"./ownSelector-f04e3140.js";import{S as P}from"./react-select.esm-92d2e1b8.js";import{g as $e,b as je,a as ye}from"./operationsFilters-6a0640c3.js";import{S as U}from"./SectionTitle-0d39f299.js";import{b as Ce}from"./operationsDrinks-93c77dad.js";import{c as Te}from"./coctailPlaceholder-8f20128c.js";const Se=B().shape({drink:y().required("This field is required!").min(2,"This field must be 2-30 symbols long").max(35,"This field must be 2-35 symbols long"),description:y().required("This field is required!").min(25,"This field must be 25-234 symbols long").max(234,"This field must be 25-234 symbols long"),ingredients:ne().of(B().shape({title:y().required("This field is required!"),measure:y().required("This field is required!")})),instructions:y().required("This field is required!").min(25,"This field must be 25-2000 symbols long").max(2e3,"This field must be 25-2000 symbols long"),category:y().required("This field is required!"),glass:y().required("This field is required!"),alcoholic:y().required("Select the type of drink"),drinkThumb:re().required("Drink photo is required!").test("is-valid-type","Wrong file format! Only jpg, jpeg, png, avif, bmp, webp files are allowed",e=>ae(e&&e.name.toLowerCase(),"image")).test("is-valid-size","Max allowed size is 100KB",e=>e&&e.size<=102400)}),Le=i.section`
`;i.div`
`;const De=i.button`
  margin-top: 20px;
  padding-top: 14px;
...
`,ht=i(Ye)`
  stroke: currentColor;
`,xt=({values:e,errors:o,touched:n,handleChange:d,handleBlur:p,setFieldValue:r,themeColors:m})=>{const[v,h]=s.useState([]),[f,l]=s.useState([]);s.useEffect(()=>{async function u(){try{const b=(await ye()).map(g=>({label:g.title,value:g._id}));h(b)}catch(c){console.error("Ошибка при загрузке ингридиента:",c)}}u()},[]);const w=(u,c)=>{let b="",g="";u&&(b=u.value,g=u.label),r(`ingredients[${c}].title`,g),r(`ingredients[${c}]._id`,b),l(j=>{const T=[...j];return T[c]=u,T})},C=()=>{const u={name:""};r("ingredients",[...e.ingredients,u]),l(c=>[...c,null])},$=u=>{const c=[...e.ingredients];c.length===1?(r("ingredients",[{title:"",measure:""}]),l(b=>[])):(c.splice(u,1),r("ingredients",c),l(b=>{const g=[...b];return g.splice(u,1),g}))},D=e.ingredients.length===1;return t.jsxs(Ke,{className:"ingredients-fields","aria-labelledby":"ingredients-title",children:[t.jsxs(Je,{children:[t.jsx(Xe,{id:"ingredients-title",children:"Ingredients"}),t.jsxs(Qe,{children:[t.jsx(G,{type:"button",onClick:()=>$(e.ingredients.length-1),disabled:D,"aria-label":"remove ingredient",children:t.jsx(Ze,{})}),t.jsx("div",{children:e.ingredients.length}),t.jsx(G,{type:"button",onClick:C,"aria-label":"add ingredient",children:t.jsx(et,{})})]})]}),t.jsx(tt,{children:e.ingredients.map((u,c)=>{var b,g,j;return t.jsxs(it,{children:[t.jsxs(ot,{children:[t.jsxs(nt,{children:[t.jsx(rt,{children:t.jsx(P,{isClearable:!0,name:`ingredients[${c}].title`,placeholder:"Ingredient",value:f[c]||null,options:v,onChange:T=>w(T,c),onBlur:p,styles:at(f[c],m),"aria-label":"ingredient name"})}),n.ingredients&&o.ingredients&&n.ingredients[c]&&((b=o.ingredients[c])!=null&&b.title)?t.jsx(x,{children:((g=o.ingredients[c])==null?void 0:g.title)||""}):t.jsx(x,{})]}),t.jsxs(st,{children:[t.jsx(lt,{type:"text",name:`ingredients[${c}].measure`,placeholder:"1 cl",maxLength:15,value:u.measure||"",onChange:d,onBlur:p,"aria-label":"ingredient measure"}),n.ingredients&&o.ingredients&&n.ingredients[c]&&((j=o.ingredients[c])!=null&&j.measure)?t.jsxs(x,{children:[o.ingredients[c].measure," "]}):t.jsx(x,{})]})]}),t.jsxs(dt,{children:[t.jsx(ct,{children:t.jsx(pt,{type:"button",onClick:()=>$(c),"aria-label":"remove ingredient",children:t.jsx(ht,{})})}),t.jsx(x,{})]})]},c)})})]})},mt=i.h3`
  font-size: 28px;
  font-weight: 600;
  line-height: 1.14;
  margin-top: 80px;
...
`,ft=({values:e,errors:o,touched:n,handleChange:d,handleBlur:p})=>{const[r,m]=s.useState(!1),[v,h]=s.useState(!1),f=l=>{const{value:w}=l.target;h(w.trim().length>0)};return t.jsxs("div",{"aria-labelledby":"recipe-title",children:[t.jsx(mt,{id:"recipe-title",children:"Recipe Preparation"}),t.jsxs(ut,{children:[t.jsx(gt,{htmlFor:"instructions",$isFocusedPreparation:r,$hasValuePreparation:v,children:"Enter the recipe"}),t.jsx(bt,{id:"instructions",name:"instructions",rows:"6",onChange:l=>{f(l),d(l)},onBlur:l=>{m(!1),p(l)},onFocus:()=>m(!0),value:e.instructions,placeholder:" ","aria-label":"preparation recipe"}),n.instructions&&o.instructions?t.jsx(x,{children:o.instructions}):t.jsx(x,{})]})]})},wt=()=>{const e=se(),o=le(),{theme:n}=s.useContext(de),d=n==="dark"?{...xe}:{...me},p=E(ke),r=E(ve);s.useEffect(()=>{r&&e("/my")},[r]);const m=async(h,{resetForm:f})=>{const l=new FormData;l.append("drink",h.drink),l.append("category",h.category),l.append("shortDescription",h.description),l.append("description",h.description),l.append("alcoholic",h.alcoholic),l.append("instructions",h.instructions),l.append("glass",h.glass),l.append("drinkThumb",h.drinkThumb),l.append("ingredients",JSON.stringify(h.ingredients)),o(ue(l))},v={drink:"",description:"",ingredients:[{title:"",measure:""}],instructions:"",category:"",glass:"",alcoholic:"Non alcoholic",drinkThumb:""};return t.jsxs(Le,{"aria-labelledby":"add-drink-form-title",children:[t.jsx(U,{id:"add-drink-form-title",title:"Add drink form",hidden:!0}),t.jsx(ce,{initialValues:v,validationSchema:Se,onSubmit:m,children:({values:h,errors:f,touched:l,handleChange:w,handleBlur:C,setFieldValue:$})=>t.jsxs(pe,{children:[t.jsx(Ge,{values:h,errors:f,touched:l,handleChange:w,handleBlur:C,setFieldValue:$,themeColors:d}),t.jsx(xt,{values:h,errors:f,touched:l,handleChange:w,handleBlur:C,setFieldValue:$,themeColors:d}),t.jsx(ft,{values:h,errors:f,touched:l,handleChange:w,handleBlur:C,setFieldValue:$}),t.jsx(De,{type:"submit","aria-label":"click button to add new drink to your own collection",children:"Add"})]})}),p&&t.jsx(he,{children:t.jsx(we,{color:"currentColor",width:"60"})})]})},kt=i.div`
  margin-top: 80px;
  @media (min-width: 1280px) {
    margin-top: 0;
  }
...
`,Ft=i.p`
  ...
  color:  ${e=>e.theme.mainTextColor};
  transition: color var(--transition);
`,zt=()=>{const[e,o]=s.useState([]);return s.useEffect(()=>{(async()=>{try{const d=await Ce();o(d)}catch(d){console.error("Error fetching drinks:",d)}})()},[]),t.jsxs("div",{"aria-labelledby":"popular-drinks-title",children:[t.jsx(Tt,{id:"popular-drinks-title",children:"Popular Drinks"}),t.jsxs(Ct,{children:[" ",e.slice(0,4).map(({drinkThumb:n={defaultImg:Te},drink:d,description:p,_id:r},m)=>t.jsx(be,{to:`/drink/${r}`,"aria-labelledby":"popular-drink-name",children:t.jsxs(St,{children:[t.jsx(Lt,{src:n,alt:d,"aria-labelledby":"popular-drink-name"}),t.jsxs(Dt,{children:[t.jsx(It,{id:"popular-drink-name",children:d}),t.jsx(Ft,{"aria-labelledby":"popular-drink-name",children:p})]})]})},m))]})]})},Pt=()=>t.jsxs(jt,{children:[t.jsx(wt,{}),t.jsxs(yt,{"aria-labelledby":"aside-title",children:[t.jsx(U,{id:"aside-title",title:"socials links and popular drinks",hidden:!0}),t.jsx($t,{}),t.jsx(zt,{})]})]}),Ot=()=>t.jsxs(t.Fragment,{children:[t.jsx(fe,{title:"Add drink",marginBottom:["40px","60px","60px"]}),t.jsx(Pt,{})]});export{Ot as default};
