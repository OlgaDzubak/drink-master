import{k as V,l as j,m as Q,o as Z,p as ee,n as i,r as l,j as t,u as te,q as ie,G as oe,s as N,F as ne,t as re,v as ae,g as se,h as le,w as de,M as ce,x as pe}from"./index-442329cc.js";import{P as he}from"./PageTitle-a5575c55.js";import{T as xe}from"./Hourglass-42e0c5b8.js";import{s as me,a as ge}from"./ownSelector-f04e3140.js";import{S as F}from"./react-select.esm-f872e8d0.js";import{g as ue,b as be,a as fe}from"./operationsFilters-78bbd3ec.js";import{S as we}from"./SectionTitle-5d2d4943.js";import{b as ke}from"./operationsDrinks-0e78c093.js";import"./Titles.styled-e053dfec.js";const ve=V().shape({drink:j().required("This field is required!").min(2,"This field must be 2-30 symbols long").max(30,"This field must be 2-30 symbols long"),description:j().required("This field is required!").min(25,"This field must be 25-234 symbols long").max(234,"This field must be 25-234 symbols long"),ingredients:Q().of(V().shape({title:j().required("This field is required!"),measure:j().required("This field is required!")})),instructions:j().required("This field is required!").min(25,"This field must be 25-2000 symbols long").max(2e3,"This field must be 25-2000 symbols long"),category:j().required("This field is required!"),glass:j().required("This field is required!"),alcoholic:j().required("Select the type of drink"),drinkThumb:Z().required("Drink photo is required!").test("is-valid-type","Wrong file format! Only jpg, jpeg, png files are allowed",e=>ee(e&&e.name.toLowerCase(),"image")).test("is-valid-size","Max allowed size is 100KB",e=>e&&e.size<=102400)}),je=i.section`
`;i.div`
`;const $e=i.button`
  margin-top: 20px;
  padding-top: 14px;
