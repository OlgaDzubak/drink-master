import{k as B,l as C,m as oe,o as ne,p as re,n as i,r as s,j as t,u as ae,q as se,G as le,s as E,F as ce,t as de,v as pe,h as he,i as xe,w as me,M as ue,x as ge}from"./index-007dd3fb.js";import{P as be}from"./PageTitle-53661ba3.js";import{T as fe}from"./Hourglass-dad116e2.js";import{s as we,a as ke}from"./ownSelector-f04e3140.js";import{S as P}from"./react-select.esm-a14b78bf.js";import{g as ve,b as $e,a as je}from"./operationsFilters-2e12fe05.js";import{S as Ce}from"./SectionTitle-fd9536a9.js";import{b as ye}from"./operationsDrinks-068d9f92.js";import{c as Te}from"./coctailPlaceholder-2da96a7e.js";const Se=B().shape({drink:C().required("This field is required!").min(2,"This field must be 2-30 symbols long").max(35,"This field must be 2-35 symbols long"),description:C().required("This field is required!").min(25,"This field must be 25-234 symbols long").max(234,"This field must be 25-234 symbols long"),ingredients:oe().of(B().shape({title:C().required("This field is required!"),measure:C().required("This field is required!")})),instructions:C().required("This field is required!").min(25,"This field must be 25-2000 symbols long").max(2e3,"This field must be 25-2000 symbols long"),category:C().required("This field is required!"),glass:C().required("This field is required!"),alcoholic:C().required("Select the type of drink"),drinkThumb:ne().required("Drink photo is required!").test("is-valid-type","Wrong file format! Only jpg, jpeg, png files are allowed",e=>re(e&&e.name.toLowerCase(),"image")).test("is-valid-size","Max allowed size is 100KB",e=>e&&e.size<=102400)}),Le=i.section`
`;i.div`
`;const De=i.button`
  margin-top: 20px;
  padding-top: 14px;
...
`,Ge=({values:e,errors:o,touched:n,handleChange:c,handleBlur:p,setFieldValue:r,themeColors:m})=>{const[v,h]=s.useState(null),[f,l]=s.useState(!1),[w,y]=s.useState(!1),[$,D]=s.useState(!1),[u,d]=s.useState(!1),[b,g]=s.useState([]),[j,T]=s.useState([]),[U,V]=s.useState(!1),[_,Y]=s.useState([]),[F,K]=s.useState([]),[J,N]=s.useState(!1);s.useEffect(()=>{async function a(){try{const z=(await ve()).map(L=>({value:L,label:L}));g(z)}catch(S){console.error("Ошибка при загрузке категорий:",S)}}async function k(){try{const z=(await $e()).map(L=>({value:L,label:L}));Y(z)}catch(S){console.error("Ошибка при загрузке категорий:",S)}}a(),k()},[]);const X=a=>{const k=a.target.files[0]||null;r("drinkThumb",k),h(k?URL.createObjectURL(k):null)},Q=a=>{const{value:k}=a.target;y(k.trim().length>1)},Z=a=>{const{value:k}=a.target;d(k.trim().length>1)},ee=a=>{T(a||[]),r("category",(a==null?void 0:a.value)||"")},te=a=>{K(a||[]),r("glass",(a==null?void 0:a.value)||"")},ie=a=>{};return t.jsxs(Fe,{className:"description-fields",children:[t.jsxs(ze,{children:[t.jsxs(Pe,{"aria-label":"click to add drink photo",children:[t.jsxs(Ve,{htmlFor:"drinkThumb",children:[t.jsx(Ne,{type:"file",id:"drinkThumb",name:"drinkThumb",onChange:a=>X(a)}),t.jsxs(Be,{children:[t.jsx(Ee,{className:"add-div",children:t.jsx(Me,{})}),t.jsx(He,{children:"Add image"})]})]}),v&&t.jsx(Ae,{src:v,alt:"Selected"})]}),n.drinkThumb&&o.drinkThumb?t.jsx(x,{children:o.drinkThumb}):null]}),t.jsxs(Re,{children:[t.jsxs(I,{className:"name",children:[t.jsx(qe,{htmlFor:"drink",$isFocused:f,$hasValue:w,children:"Enter drink title"}),t.jsx(M,{type:"text",id:"drink",name:"drink",minLength:2,maxLength:35,onChange:a=>{Q(a),c(a)},onBlur:a=>{l(!1),p(a)},onFocus:()=>l(!0),value:e.drink,"aria-label":"enter a drink name between two and thirty-five characters long"}),n.drink&&o.drink?t.jsx(x,{children:o.drink}):t.jsx(x,{})]}),t.jsxs(I,{className:"description",children:[t.jsx(Oe,{htmlFor:"description",$isFocusedDescription:$,$hasValueDescription:u,children:"Enter drink description"}),t.jsx(M,{type:"text",rows:1,minLength:25,maxLength:250,id:"description",name:"description",onChange:a=>{Z(a),c(a)},onBlur:a=>{D(!1),p(a)},onFocus:()=>D(!0),value:e.description,"aria-label":"enter a description of the drink between twenty-five and two hundred and fifty characters long"}),n.description&&o.description?t.jsx(x,{children:o.description}):t.jsx(x,{})]}),t.jsx(I,{className:"category",children:t.jsxs(H,{children:[t.jsx(A,{htmlFor:"category-input",selectedCategory:j.label,$isFocused:U,children:"Choose drink category"}),t.jsx(P,{isClearable:!0,inputId:"category-input",name:"category",options:b,value:j,onChange:a=>ee(a),onFocus:()=>V(!0),onBlur:a=>{V(!1),p(a)},styles:R("199px","405px","205px",j,m),placeholder:"","aria-label":"select a drink category from pop-up menu"}),n.category&&o.category?t.jsx(x,{children:o.category}):t.jsx(x,{})]})}),t.jsx(I,{className:"glass",children:t.jsxs(H,{children:[t.jsx(A,{htmlFor:"glass-input",selectedCategory:F.label,$isFocused:J,children:"Choose drink glass"}),t.jsx(P,{isClearable:!0,inputId:"glass-input",name:"glass",options:_,value:F,onChange:a=>te(a),onFocus:()=>N(!0),onBlur:a=>{N(!1),p(a)},onMenuOpen:ie,styles:R("199px","305px","205px",F,m),placeholder:"","aria-label":"select the type of drink glass from pop-up menu"}),n.glass&&o.glass?t.jsx(x,{children:o.glass}):t.jsx(x,{})]})}),t.jsxs(We,{className:"alcoholic",children:[t.jsxs(q,{className:e.alcoholic==="Alcoholic"?"checked":"",children:[t.jsx(O,{type:"radio",name:"alcoholic",value:"Alcoholic",checked:e.alcoholic==="Alcoholic",onChange:c,"aria-label":"click the radio button if drink is alcoholic"}),t.jsx(W,{}),"Alcoholic"]}),t.jsxs(q,{className:e.alcoholic==="Non alcoholic"?"checked":"",children:[t.jsx(O,{type:"radio",name:"alcoholic",value:"Non alcoholic",checked:e.alcoholic==="Non alcoholic",onChange:c,"aria-label":"click the radio button if drink is non-alcoholic"}),t.jsx(W,{}),"Non-alcoholic"]}),n.alcoholic&&o.alcoholic?t.jsx(x,{children:o.alcoholic}):null]})]})]})},Ue=e=>s.createElement("svg",{width:16,height:16,viewBox:"0 0 16 16",fill:"none",xmlns:"http://www.w3.org/2000/svg",...e},s.createElement("path",{d:"M2.5 8H13.5",strokeWidth:1.5,strokeLinecap:"round",strokeLinejoin:"round"}),s.createElement("path",{d:"M8 2.5V13.5",strokeWidth:1.5,strokeLinecap:"round",strokeLinejoin:"round"})),_e=e=>s.createElement("svg",{width:16,height:16,viewBox:"0 0 16 16",fill:"none",xmlns:"http://www.w3.org/2000/svg",...e},s.createElement("path",{d:"M2.5 8H13.5",strokeWidth:1.5,strokeLinecap:"round",strokeLinejoin:"round"})),Ye=e=>s.createElement("svg",{width:20,height:20,viewBox:"0 0 20 20",fill:"none",xmlns:"http://www.w3.org/2000/svg",...e},s.createElement("path",{d:"M15.625 4.375L4.375 15.625",strokeWidth:1.5,strokeLinecap:"round",strokeLinejoin:"round"}),s.createElement("path",{d:"M15.625 15.625L4.375 4.375",strokeWidth:1.5,strokeLinecap:"round",strokeLinejoin:"round"}));i.p`
  padding-left: 5px;
  margin-top: 5px;
  font-size: 12px;
  line-height: 1.67;
...
`,ht=i(Ye)`
  stroke: currentColor;
`,xt=({values:e,errors:o,touched:n,handleChange:c,handleBlur:p,setFieldValue:r,themeColors:m})=>{const[v,h]=s.useState([]),[f,l]=s.useState([]);s.useEffect(()=>{async function u(){try{const b=(await je()).map(g=>({label:g.title,value:g._id}));h(b)}catch(d){console.error("Ошибка при загрузке ингридиента:",d)}}u()},[]);const w=(u,d)=>{let b="",g="";u&&(b=u.value,g=u.label),r(`ingredients[${d}].title`,g),r(`ingredients[${d}]._id`,b),l(j=>{const T=[...j];return T[d]=u,T})},y=()=>{const u={name:""};r("ingredients",[...e.ingredients,u]),l(d=>[...d,null])},$=u=>{const d=[...e.ingredients];d.length===1?(r("ingredients",[{title:"",measure:""}]),l(b=>[])):(d.splice(u,1),r("ingredients",d),l(b=>{const g=[...b];return g.splice(u,1),g}))},D=e.ingredients.length===1;return t.jsxs(Ke,{className:"ingredients-fields",children:[t.jsxs(Je,{children:[t.jsx(Xe,{children:"Ingredients"}),t.jsxs(Qe,{children:[t.jsx(G,{type:"button",onClick:()=>$(e.ingredients.length-1),disabled:D,"aria-label":"click to remove one ingredient field from the end of list",children:t.jsx(Ze,{})}),t.jsx("div",{children:e.ingredients.length}),t.jsx(G,{type:"button",onClick:y,"aria-label":"click to add one ingredient field to the end of list",children:t.jsx(et,{})})]})]}),t.jsx(tt,{children:e.ingredients.map((u,d)=>{var b,g,j;return t.jsxs(it,{children:[t.jsxs(ot,{children:[t.jsxs(nt,{children:[t.jsx(rt,{children:t.jsx(P,{isClearable:!0,name:`ingredients[${d}].title`,placeholder:"Ingredient",value:f[d]||null,options:v,onChange:T=>w(T,d),onBlur:p,styles:at(f[d],m),"aria-label":"select one ingredient from pop-up menu"})}),n.ingredients&&o.ingredients&&n.ingredients[d]&&((b=o.ingredients[d])!=null&&b.title)?t.jsx(x,{children:((g=o.ingredients[d])==null?void 0:g.title)||""}):t.jsx(x,{})]}),t.jsxs(st,{children:[t.jsx(lt,{type:"text",name:`ingredients[${d}].measure`,placeholder:"1 cl",maxLength:15,value:u.measure||"",onChange:c,onBlur:p,"aria-label":"enter the ingredient measure, a string of maximum fifteen characters long"}),n.ingredients&&o.ingredients&&n.ingredients[d]&&((j=o.ingredients[d])!=null&&j.measure)?t.jsxs(x,{children:[o.ingredients[d].measure," "]}):t.jsx(x,{})]})]}),t.jsxs(ct,{children:[t.jsx(dt,{children:t.jsx(pt,{type:"button",onClick:()=>$(d),"aria-label":"click to remove ingredient field",children:t.jsx(ht,{})})}),t.jsx(x,{})]})]},d)})})]})},mt=i.h3`
  font-size: 28px;
  font-weight: 600;
  line-height: 1.14;
  margin-top: 80px;
...
`,ft=({values:e,errors:o,touched:n,handleChange:c,handleBlur:p})=>{const[r,m]=s.useState(!1),[v,h]=s.useState(!1),f=l=>{const{value:w}=l.target;h(w.trim().length>0)};return t.jsxs(t.Fragment,{children:[t.jsx(mt,{children:"Recipe Preparation"}),t.jsxs(ut,{children:[t.jsx(gt,{htmlFor:"instructions",$isFocusedPreparation:r,$hasValuePreparation:v,children:"Enter the recipe"}),t.jsx(bt,{id:"instructions",name:"instructions",rows:"6",onChange:l=>{f(l),c(l)},onBlur:l=>{m(!1),p(l)},onFocus:()=>m(!0),value:e.instructions,placeholder:" ","aria-label":"enter the preparation recipe"}),n.instructions&&o.instructions?t.jsx(x,{children:o.instructions}):t.jsx(x,{})]})]})},wt=()=>{const e=ae(),o=se(),{theme:n}=s.useContext(le),c=n==="dark"?{...he}:{...xe},p=E(we),r=E(ke);s.useEffect(()=>{r&&e("/my")},[r]);const m=async(h,{resetForm:f})=>{const l=new FormData;l.append("drink",h.drink),l.append("category",h.category),l.append("shortDescription",h.description),l.append("description",h.description),l.append("alcoholic",h.alcoholic),l.append("instructions",h.instructions),l.append("glass",h.glass),l.append("drinkThumb",h.drinkThumb),l.append("ingredients",JSON.stringify(h.ingredients)),o(me(l))},v={drink:"",description:"",ingredients:[{title:"",measure:""}],instructions:"",category:"",glass:"",alcoholic:"Non alcoholic",drinkThumb:""};return t.jsxs(Le,{children:[t.jsx(Ce,{title:"Add drink form",hidden:!0}),t.jsx(ce,{initialValues:v,validationSchema:Se,onSubmit:m,children:({values:h,errors:f,touched:l,handleChange:w,handleBlur:y,setFieldValue:$})=>t.jsxs(de,{children:[t.jsx(Ge,{values:h,errors:f,touched:l,handleChange:w,handleBlur:y,setFieldValue:$,themeColors:c}),t.jsx(xt,{values:h,errors:f,touched:l,handleChange:w,handleBlur:y,setFieldValue:$,themeColors:c}),t.jsx(ft,{values:h,errors:f,touched:l,handleChange:w,handleBlur:y,setFieldValue:$}),t.jsx(De,{type:"submit","aria-label":"click button to add new drink to your own collection",children:"Add"})]})}),p&&t.jsx(pe,{children:t.jsx(fe,{color:"currentColor",width:"60"})})]})},kt=i.div`
  margin-top: 80px;
  @media (min-width: 1280px) {
    margin-top: 0;
  }
...
`,$t=()=>t.jsxs(kt,{children:[t.jsx(vt,{children:"Follow Us"}),t.jsx(ue,{})]});i.h2`
  font-size: 32px;
  font-weight: 600;
  line-height: 1.1875;
  margin-bottom: 40px;
...
`,Ft=i.p`
  ...
  color:  ${e=>e.theme.mainTextColor};
  transition: color var(--transition);
`,zt=()=>{const[e,o]=s.useState([]);return s.useEffect(()=>{(async()=>{try{const c=await ye();o(c)}catch(c){console.error("Error fetching drinks:",c)}})()},[]),t.jsxs(t.Fragment,{children:[t.jsx(Tt,{children:"Popular Drink"}),t.jsxs(yt,{children:[" ",e.slice(0,4).map(({drinkThumb:n={defaultImg:Te},drink:c,description:p,_id:r},m)=>t.jsx(ge,{to:`/drink/${r}`,"aria-label":"click to see more information about drink",children:t.jsxs(St,{children:[t.jsx(Lt,{src:n,alt:c}),t.jsxs(Dt,{children:[t.jsx(It,{children:c}),t.jsx(Ft,{children:p})]})]})},m))]})]})},Pt=()=>t.jsxs(jt,{children:[t.jsx(wt,{}),t.jsxs(Ct,{children:[t.jsx($t,{}),t.jsx(zt,{})]})]}),Ot=()=>t.jsxs(t.Fragment,{children:[t.jsx(be,{title:"Add drink"}),t.jsx(Pt,{})]});export{Ot as default};
