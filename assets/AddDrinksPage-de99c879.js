import{k as B,l as C,m as oe,o as ne,p as re,n as i,r as s,j as t,u as ae,q as se,G as le,s as E,F as ce,t as de,v as pe,h as he,i as xe,w as ue,M as me,x as ge}from"./index-157f7aee.js";import{P as be}from"./PageTitle-3766935e.js";import{T as fe}from"./Hourglass-e3d50621.js";import{s as we,a as ke}from"./ownSelector-f04e3140.js";import{S as P}from"./react-select.esm-75fc0f0f.js";import{g as ve,b as $e,a as je}from"./operationsFilters-94ec0050.js";import{S as Ce}from"./SectionTitle-e1addcdd.js";import{b as ye}from"./operationsDrinks-591980d5.js";import{c as Te}from"./coctailPlaceholder-8af3da2a.js";const Se=B().shape({drink:C().required("This field is required!").min(2,"This field must be 2-30 symbols long").max(35,"This field must be 2-35 symbols long"),description:C().required("This field is required!").min(25,"This field must be 25-234 symbols long").max(234,"This field must be 25-234 symbols long"),ingredients:oe().of(B().shape({title:C().required("This field is required!"),measure:C().required("This field is required!")})),instructions:C().required("This field is required!").min(25,"This field must be 25-2000 symbols long").max(2e3,"This field must be 25-2000 symbols long"),category:C().required("This field is required!"),glass:C().required("This field is required!"),alcoholic:C().required("Select the type of drink"),drinkThumb:ne().required("Drink photo is required!").test("is-valid-type","Wrong file format! Only jpg, jpeg, png files are allowed",e=>re(e&&e.name.toLowerCase(),"image")).test("is-valid-size","Max allowed size is 100KB",e=>e&&e.size<=102400)}),Le=i.section`
`;i.div`
`;const De=i.button`
  margin-top: 20px;
  padding-top: 14px;
