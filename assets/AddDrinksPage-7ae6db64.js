import{k as B,l as C,m as oe,o as ne,p as re,n as i,r as s,j as t,u as ae,q as se,G as le,s as E,F as ce,t as de,v as pe,h as he,i as xe,w as me,M as ue,x as ge}from"./index-426e2c1a.js";import{P as be}from"./PageTitle-53c83c20.js";import{T as fe}from"./Hourglass-94b9fd16.js";import{s as we,a as ke}from"./ownSelector-f04e3140.js";import{S as P}from"./react-select.esm-56cc4d86.js";import{g as ve,b as $e,a as je}from"./operationsFilters-262dc743.js";import{S as Ce}from"./SectionTitle-4b06bcda.js";import{b as ye}from"./operationsDrinks-cd074ab3.js";import{c as Te}from"./coctailPlaceholder-fc138ba5.js";const Se=B().shape({drink:C().required("This field is required!").min(2,"This field must be 2-30 symbols long").max(35,"This field must be 2-35 symbols long"),description:C().required("This field is required!").min(25,"This field must be 25-234 symbols long").max(234,"This field must be 25-234 symbols long"),ingredients:oe().of(B().shape({title:C().required("This field is required!"),measure:C().required("This field is required!")})),instructions:C().required("This field is required!").min(25,"This field must be 25-2000 symbols long").max(2e3,"This field must be 25-2000 symbols long"),category:C().required("This field is required!"),glass:C().required("This field is required!"),alcoholic:C().required("Select the type of drink"),drinkThumb:ne().required("Drink photo is required!").test("is-valid-type","Wrong file format! Only jpg, jpeg, png files are allowed",e=>re(e&&e.name.toLowerCase(),"image")).test("is-valid-size","Max allowed size is 100KB",e=>e&&e.size<=102400)}),Le=i.section`
`;i.div`
`;const De=i.button`
  margin-top: 20px;
  padding-top: 14px;
...
`,Ft=i.p`
  ...
  color:  ${e=>e.theme.mainTextColor};
  transition: color var(--transition);
`,zt=()=>{const[e,o]=s.useState([]);return s.useEffect(()=>{(async()=>{try{const c=await ye();o(c)}catch(c){console.error("Error fetching drinks:",c)}})()},[]),t.jsxs(t.Fragment,{children:[t.jsx(Tt,{children:"Popular Drink"}),t.jsxs(yt,{children:[" ",e.slice(0,4).map(({drinkThumb:n={defaultImg:Te},drink:c,description:p,_id:r},m)=>t.jsx(ge,{to:`/drink/${r}`,children:t.jsxs(St,{children:[t.jsx(Lt,{src:n,alt:c}),t.jsxs(Dt,{children:[t.jsx(It,{children:c}),t.jsx(Ft,{children:p})]})]})},m))]})]})},Pt=()=>t.jsxs(jt,{children:[t.jsx(wt,{}),t.jsxs(Ct,{children:[t.jsx($t,{}),t.jsx(zt,{})]})]}),Ot=()=>t.jsxs(t.Fragment,{children:[t.jsx(be,{title:"Add drink"}),t.jsx(Pt,{})]});export{Ot as default};
