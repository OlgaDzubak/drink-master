import{n as e,L as d,j as o,r as s,B as m}from"./index-026d441c.js";import{P as x}from"./PageTitle-fcfd4094.js";import{g as p}from"./operationsDrinks-754a12e8.js";import{D as h}from"./DrinkCard-a5ebdaa0.js";const g=e.section`
  display: flex;
...
`,D="/drink-master/assets/coctailPhoto_1-1d38e785.png",z=()=>o.jsx(g,{children:o.jsxs(b,{children:[o.jsxs(f,{children:[o.jsxs(w,{children:["Craft Your Perfect",o.jsx("br",{})," Drink with Drink Master"]}),o.jsx(k,{children:"Unlock your inner mixologist with Drink Master, your one-stop destination for exploring, crafting, and mastering the world´s finest beverages."}),o.jsx(u,{to:"/add",children:"Add drink"})]}),o.jsx(y,{src:D,alt:"main-coctail"})]})}),H=()=>{const[i,c]=s.useState([]);return s.useEffect(()=>{(async()=>{try{const n=window.innerWidth>=1280?3:window.innerWidth>=768?2:1,t=await p(n),a=Object.entries(t);c([...a])}catch(n){console.error("Error fetching drinks:",n)}})()},[]),o.jsxs(j,{children:[o.jsx(v,{children:i.map(([r,n])=>o.jsxs("li",{children:[o.jsx(B,{children:r}),o.jsx(C,{children:n.map(({_id:t,drink:a,drinkThumb:l})=>o.jsx(h,{location:"home",_id:t,drink:a,drinkThumb:l},t))})]},r))}),o.jsx($,{to:"/drinks",children:"Other Drinks"})]})},P=()=>o.jsxs(o.Fragment,{children:[o.jsx(x,{title:"Home page",hidden:!0}),o.jsx(z,{}),o.jsx(H,{}),o.jsx(m,{})]});export{P as default};
