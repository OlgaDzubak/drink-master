import{c as V,d as j,e as Q,f as Z,i as ee,n as i,r as l,j as t,u as te,g as ie,G as ne,h as N,F as oe,k as re,l as ae,D as se,a as le,m as ce,M as de,L as pe}from"./index-c8f05b76.js";import{P as he}from"./PageTitle-e8745b4e.js";import{T as xe}from"./Hourglass-5e67e8ae.js";import{s as me,a as ue}from"./ownSelector-f04e3140.js";import{S as z}from"./react-select.esm-238c9760.js";import{g as ge,b as be,a as fe}from"./operationsFilters-7b0dac3a.js";import{b as we}from"./operationsDrinks-fcf86879.js";const ke=V().shape({drink:j().required("This field is required!").min(2,"This field must be 2-30 symbols long").max(30,"This field must be 2-30 symbols long"),description:j().required("This field is required!").min(25,"This field must be 25-234 symbols long").max(234,"This field must be 25-234 symbols long"),ingredients:Q().of(V().shape({title:j().required("This field is required!"),measure:j().required("This field is required!")})),instructions:j().required("This field is required!").min(25,"This field must be 25-2000 symbols long").max(2e3,"This field must be 25-2000 symbols long"),category:j().required("This field is required!"),glass:j().required("This field is required!"),alcoholic:j().required("Select the type of drink"),drinkThumb:Z().required("Drink photo is required!").test("is-valid-type","Wrong file format! Only jpg, jpeg, png files are allowed",e=>ee(e&&e.name.toLowerCase(),"image")).test("is-valid-size","Max allowed size is 100KB",e=>e&&e.size<=102400)}),ve=i.section`
`;i.div`
`;const je=i.button`
  margin-top: 20px;
  padding-top: 14px;
