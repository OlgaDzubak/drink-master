import{k as B,l as y,m as ne,o as re,p as ae,n as i,r as s,j as t,u as se,q as le,G as de,s as E,F as ce,t as pe,v as he,h as xe,i as ue,w as me,M as ge,x as be}from"./index-dc5bf24c.js";import{P as fe}from"./PageTitle-308f063c.js";import{T as we}from"./Hourglass-b67d6be3.js";import{s as ke,a as ve}from"./ownSelector-f04e3140.js";import{S as P}from"./react-select.esm-1d2ce36e.js";import{g as $e,b as je,a as ye}from"./operationsFilters-f0dae568.js";import{S as U}from"./SectionTitle-fbd8b13b.js";import{b as Ce}from"./operationsDrinks-c91116ba.js";import{c as Te}from"./coctailPlaceholder-3a35aade.js";const Se=B().shape({drink:y().required("This field is required!").min(2,"This field must be 2-30 symbols long").max(35,"This field must be 2-35 symbols long"),description:y().required("This field is required!").min(25,"This field must be 25-234 symbols long").max(234,"This field must be 25-234 symbols long"),ingredients:ne().of(B().shape({title:y().required("This field is required!"),measure:y().required("This field is required!")})),instructions:y().required("This field is required!").min(25,"This field must be 25-2000 symbols long").max(2e3,"This field must be 25-2000 symbols long"),category:y().required("This field is required!"),glass:y().required("This field is required!"),alcoholic:y().required("Select the type of drink"),drinkThumb:re().required("Drink photo is required!").test("is-valid-type","Wrong file format! Only jpg, jpeg, png files are allowed",e=>ae(e&&e.name.toLowerCase(),"image")).test("is-valid-size","Max allowed size is 100KB",e=>e&&e.size<=102400)}),Le=i.section`
`;i.div`
`;const De=i.button`
  margin-top: 20px;
  padding-top: 14px;
